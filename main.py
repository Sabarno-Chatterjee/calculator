...
eight_button = Button(width=4, height=1, text="8", font=("arial", 20,"bold"), bg=black, fg=white)
...
clear_button = Button(width=4, height=1, text="C", font=("arial", 20,"bold"), bg=black, fg=white)
